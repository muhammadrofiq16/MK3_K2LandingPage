...
<head>
    ...
    <title>iLuxury | Premium iPhone Experience</title>
...
<body>
    ...
    <section class="hero" id="home">
        <div class="hero-content">
            <h1>Kualitas Terjaga, Keanggunan Tak Pernah Pudar</h1>
            <p>Rasakan kemewahan iPhone dengan harga lebih bersahabat, tanpa mengurangi kualitas dan performa.</p>
        ...
        <div class="testimonial-card" style="display: none;">
            ...
            <div class="testimonial-author">
                ...
                <div class="author-info">
                    ...
                    <p>Kepala SMK TELKOM PURWOKERTO</p>
                </div>
            </div>
        </div>
...
dengan layanan tak tertandingi dan produk eksklusif.</p>
    ...
    <div class="footer-bottom">
        <p>&copy; 2025 iLuxury. All rights reserved. Apple, iPhone, and iPad are trademarks of Apple Inc.</p>
    </div>
</footer>
<!-- Midtrans Payment Integration -->
<script src="https://app.sandbox.midtrans.com/snap/snap.js" 
        data-client-key="SB-Mid-client-Qa8_pqnbRqY2XTEw"></script>
